"""
Django settings for reqsys project.
...
# Tự động thêm domain của Render vào ALLOWED_HOSTS nếu có
...
MIDDLEWARE = [
    ...
    'auditlog.middleware.AuditlogMiddleware',  # Gắn request user vào audit log
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'reqsys.urls'
...
WSGI_APPLICATION = 'reqsys.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases
# Trên production (Render): đọc DATABASE_URL để dùng PostgreSQL
# Trên local: dùng SQLite
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API documentation for Request Access System',
    'VERSION': '1.0.0',
